...
/**
 * @author Tan
 * @description Supply method Update, edit, delete, show, soft
	 ...
	 public static Scanner scanner = new Scanner(System.in);
	    ...
	    public void add() {
	        ...
	        for (int i = 0; i < size; i++) {
	            if (studentList.get(i).getId() == id) {
	                ...
	                System.out.println(id +"is existed, you shoud edit");
	                def=0;
	            }
	        }
	        if(def==1) {
		        ...
		        float gpa = inputGpa();
		        Student student1 = new Student(id, name, age, address, gpa);
	    ...
	    public void show() {
	        for (Student student : studentList) {
	            ...
	            System.out.format("%10.2f%n", student.getGpa());
	        }
	    }
